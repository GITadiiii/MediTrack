...
export const LoginScreen: React.FC<LoginScreenProps> = ({ navigation }) => {
  ...
  const handleLogin = () => {
    if (!email || !pin) {
      Alert.alert('Validation Error', 'Please enter your registered email and 4-digit PIN.');
      return;
    }
    ...
    if (session) {
      ...
      Alert.alert('Login Failed', 'Incorrect email or security PIN. Please try again.');
    }
  };
